...
Plotting functions for burden diagnostics. All functions operate on data
prepared for plotting by a corresponding [plotting-preparation
function](https://vimc.github.io/vimcheck/reference/plot_prep_burden_diagnostics.md).
